    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_type', models.PositiveSmallIntegerField(choices=[(0, 'Integer'), (1, 'String'), (2, 'Boolean')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer_value_type', models.PositiveSmallIntegerField(choices=[(0, 'Integer'), (1, 'String'), (2, 'Boolean')])),
                ('content_type', models.ForeignKey(to='contenttypes.ContentType')),
            ],
            options={
                'abstract': False,
